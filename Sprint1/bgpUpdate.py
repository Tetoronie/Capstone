...
Path = BGPPathAttr(type_flags=64, type_code=2, attribute=BGPPAASPath(segment_type=2, segment_length=2, segment=[1000, 1050]))
...
UpdateBGP = BGPUpdate(path_attr=[Origin, Path, nextHop])
